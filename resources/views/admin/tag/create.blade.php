    ...
    <form  method="POST" action="{{ route('tag.store') }}" class="px-4" enctype="multipart/form-data">
        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="text" name="slug" id="slug" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="Nhập slug tag ..." required="">
            </div>
        </div>
