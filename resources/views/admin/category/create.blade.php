    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li aria-current="page">
            <div class="flex items-center">
                ...
                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Thêm danh mục mới</span>
            </div>
        </li>
    </ol>
</nav>
...
<section class="bg-gray-50 dark:bg-gray-900 py-4 sm:py-5 mt-5">
    ...
    <form  method="POST" action="{{ route('category.store') }}" class="px-4" enctype="multipart/form-data">
        @csrf
        <div class="flex flex-col gap-4">
            <div class="sm:col-span-2">
                <label for="name" class="block mb-2 font-semibold text-gray-900">Tên danh mục</label>
                <input type="text" name="name" id="name" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="Nhập tên danh mục ..." required="">
            </div>
            <div class="sm:col-span-2">
            ...
            <div class="sm:col-span-2">
                ...
                <input type="text" name="description" id="description" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" placeholder="Nhập mô tả ...">
            </div>
            <div class="sm:col-span-2">
