...
@section('title', 'Loại thông số kỹ thuật')
    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li>
            <div class="flex items-center">
                ...
                <a href="{{ route('spec-type.index') }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Loại thông số kỹ thuật</a>
            </div>
        </li>
        <li>
            <div class="flex items-center">
                ...
                <a href="{{ route('spec-type.show', $specType->id) }}" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">{{$specType->name}}</a>
            </div>
        </li>
        <li aria-current="page">
            <div class="flex items-center">
                ...
                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Cập nhật loại thông số</span>
            </div>
        </li>
    </ol>
</nav>
...
<section class="bg-gray-50 dark:bg-gray-900 py-4 sm:py-5 mt-5">
    <a href="{{ route('spec-type.index') }}" class="mx-4 mb-4 inline-flex items-center gap-1 px-4 py-2 bg-white shadow rounded hover:bg-gray-100">
    ...
    <form  method="POST" action="{{ route('spec-type.update', $specType->id) }}" class="px-4" enctype="multipart/form-data">
        ...
        <div class="flex flex-col gap-4">
            <div class="sm:col-span-2">
                <label for="id" class="block mb-2 font-semibold text-gray-900">ID loại thông số</label>
                <input type="text" name="id" id="id" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" value="{{ $specType->id }}" disabled>
            </div>
            <div class="sm:col-span-2">
