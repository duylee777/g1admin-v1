    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
        ...
        <li aria-current="page">
            <div class="flex items-center">
                ...
                <span class="ms-1 text-sm font-medium text-gray-500 md:ms-2 dark:text-gray-400">Thêm loại thông số</span>
            </div>
        </li>
    </ol>
</nav>
...
<section class="bg-gray-50 dark:bg-gray-900 py-4 sm:py-5 mt-5">
    ...
    <form  method="POST" action="{{ route('spec-type.store') }}" class="px-4" enctype="multipart/form-data">
        @csrf
