                            ...
                            <tr class="border-b ">
                                ...
                                <td class="px-4 py-3">
                                    @if($product->category_id != 0)  
                                        <span class="text-xs inline-block px-2 py-1 rounded-sm text-white bg-green-400">{{ $product->category()->category_id }}</span>
                                    @else
                                ...
                                <td class="px-4 py-3 flex items-center justify-end">
                                    <button id="data{{$product->id}}-dropdown-button" data-dropdown-toggle="data{{$product->id}}-dropdown" class="inline-flex items-center p-0.5 text-sm font-medium text-center text-gray-500 hover:text-gray-800 rounded-lg focus:outline-none dark:text-gray-400 dark:hover:text-gray-100" type="button">
                                        <svg class="w-5 h-5" aria-hidden="true" fill="currentColor" viewbox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M6 10a2 2 0 11-4 0 2 2 0 014 0zM12 10a2 2 0 11-4 0 2 2 0 014 0zM16 12a2 2 0 100-4 2 2 0 000 4z" />
                                        </svg>
                                    </button>
                                    <div id="data{{$product->id}}-dropdown" class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                        <ul class="py-1 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="data{{$product->id}}-dropdown-button">
                                            <li>
                                                <a href="{{ route('product.show', $product->id) }}" class="block py-2 px-4 text-blue-300 hover:text-white hover:bg-blue-300">Chi tiết</a>
                                            </li>
                                            <li>
                                                <a href="{{ route('product.edit', $product->id) }}" class="block py-2 px-4 text-yellow-300 hover:text-white hover:bg-yellow-300">Sửa</a>
                                            </li>
                                        </ul>
