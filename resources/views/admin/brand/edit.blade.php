        ...
        <div class="flex flex-col gap-4">
            ...
            <div class="grid grid-rows-2 lg:grid-cols-2 gap-4">
                ...
                <div class="">
                    ...
                    <input type="text" name="slug" id="slug" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5" value="{{ $brand->slug }}">
                </div>
            </div>
            <div class="">
